...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_NIDORAN_M] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_RECKLESS, ABILITY_DEFIANT, ABILITY_ANGER_POINT },
    #else
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_NONE, ABILITY_HUSTLE },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_CLEFFA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_CLEFAIRY}),
    },
#endif //P_GEN_2_CROSS_EVOS
    ...
    #else
        .abilities = { ABILITY_MIRACLE_EYE, ABILITY_NONE, ABILITY_RUN_AWAY },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
...
#define DUGTRIO_ATTACK (P_UPDATED_STATS >= GEN_7 ? 100 : 80)
    ...
    [SPECIES_PSYDUCK] =
    {
        ...
        .abilities = { ABILITY_TANGLED_FEET, ABILITY_OBLIVIOUS, ABILITY_PURE_POWER },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_MANKEY] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_RECKLESS, ABILITY_ANGER_POINT, ABILITY_BERSERK },
    #else
    ...
    [SPECIES_PRIMEAPE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_USE_MOVE_TWENTY_TIMES, MOVE_RAGE, SPECIES_ANNIHILAPE}),
    },
...
#define ALAKAZAM_SP_DEF (P_UPDATED_STATS >= GEN_6 ? 95 : 85)
    ...
    [SPECIES_MACHOKE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE, EGG_GROUP_MONSTER),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_RECKLESS, ABILITY_ANGER_POINT },
    #else
        .abilities = { ABILITY_GUTS, ABILITY_NONE, ABILITY_STEADFAST },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
...
#define GOLEM_ATTACK (P_UPDATED_STATS >= GEN_6 ? 120 : 110)
    ...
    [SPECIES_SLOWPOKE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_FAMILY_OF_FOUR, 32, SPECIES_SLOWBRO},
                                {EVO_LEVEL_FAMILY_OF_THREE, 32, SPECIES_SLOWKING},
...
#define FARFETCHD_ATTACK (P_UPDATED_STATS >= GEN_7 ? 90 : 65)
    ...
    [SPECIES_GASTLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_INFILTRATOR, ABILITY_MALICE, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_PURPLE,
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_MAROWAK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_GUTS, ABILITY_SUPREME_OVERLORD },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .evolutions = EVOLUTION({EVO_FRIENDSHIP, 0, SPECIES_KANGASKHAN}),
    },
    ...
    [SPECIES_TYROGUE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_ATK_LT_DEF, 28, SPECIES_HITMONCHAN},
                                {EVO_LEVEL_ATK_GT_DEF, 28, SPECIES_HITMONLEE},
                                {EVO_LEVEL_ATK_EQ_DEF, 28, SPECIES_HITMONTOP}),
    },
#endif //P_GEN_2_CROSS_EVOS
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .abilities = { ABILITY_CORROSION, ABILITY_GUNK_MUNCHER, ABILITY_WHITE_SMOKE },
    #else
...
// #endif //P_MEGA_EVOLUTIONS
    ...
    #else
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_NONE, ABILITY_HYDRATION },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    #else
        .abilities = { ABILITY_SWARM, ABILITY_NONE, ABILITY_RESILIENCE },
    #endif
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_TAUROS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_ANGER_POINT, ABILITY_INTIMIDATE },
    #else
