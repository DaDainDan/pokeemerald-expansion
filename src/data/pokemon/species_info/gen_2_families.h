...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGETIC] =
    {
        ...
        .evolutions = EVOLUTION({EVO_FRIENDSHIP, 0, SPECIES_TOGEKISS}),
    },
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_YANMA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_MOVE, MOVE_DRAGON_DANCE, SPECIES_YANMEGA}),
    },
    ...
    [SPECIES_MURKROW] =
    {
        ...
        .evolutions = EVOLUTION({EVO_MOVE, MOVE_NASTY_PLOT, SPECIES_HONCHKROW}),
    },
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_MOVE, MOVE_HEX, SPECIES_MISMAGIUS}),
    },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, ITEM_RAZOR_CLAW, SPECIES_WEAVILE},
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    #else
        .abilities = { ABILITY_STICKY_HOLD, ABILITY_NONE, ABILITY_MOODY },
    #endif
        .bodyColor = BODY_COLOR_RED,
...
// #endif //P_MEGA_EVOLUTIONS
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_GUTS, ABILITY_BATTLE_ARMOR, ABILITY_ANGER_POINT },
        .bodyColor = BODY_COLOR_GRAY,
