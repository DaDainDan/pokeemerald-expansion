...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_KIRLIA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_NATURE_LOW_KEY, 36, SPECIES_GARDEVOIR},
                                {EVO_LEVEL_NATURE_AMPED, 36, SPECIES_GALLADE}),
    },
    ...
    [SPECIES_NINCADA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_NINJASK, 36, SPECIES_NINJASK},
                                {EVO_LEVEL_SHEDINJA, 36, SPECIES_SHEDINJA}),
    },
    ...
    [SPECIES_SHEDINJA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_MAGIC_GUARD, ABILITY_FORBIDDEN },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PLUSLE] =
    {
        ...
        .abilities = { ABILITY_CONDUCTOR, ABILITY_NONE, ABILITY_LIGHTNING_ROD },
    #else
    ...
    [SPECIES_CAMERUPT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_ANGER_POINT, ABILITY_ADAPTABILITY, ABILITY_MAGMA_ARMOR },
    #else
    ...
    #else
        .abilities = { ABILITY_INSOMNIA, ABILITY_NONE, ABILITY_FORBIDDEN },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_ABSOL_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_WONDER_SKIN, ABILITY_SUPREME_OVERLORD },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_SNORUNT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_MALE, 47, SPECIES_GLALIE},
                                {EVO_LEVEL_FEMALE, 47, SPECIES_FROSLASS}),
    },
