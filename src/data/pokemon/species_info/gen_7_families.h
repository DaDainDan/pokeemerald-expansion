...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_YUNGOOS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_DAY, 19, SPECIES_GUMSHOOS}),
    },
    ...
    [SPECIES_FOMANTIS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_DAY, 29, SPECIES_LURANTIS},
    ...
    [SPECIES_SALANDIT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_FEMALE, 36, SPECIES_SALAZZLE},
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_KOMMO_O_TOTEM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_RESILIENCE, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Kommo-o"),
        .cryId = CRY_KOMMO_O,
        .natDexNum = NATIONAL_DEX_KOMMO_O,
    ...
    [SPECIES_TAPU_KOKO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ELECTRIC_SURGE, ABILITY_NONE, ABILITY_ANGER_POINT },
        .bodyColor = BODY_COLOR_YELLOW,
