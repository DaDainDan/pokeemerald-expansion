...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_QUAXLY] =
    {
        ...
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_NONE, ABILITY_MOXIE },
    ...
    [SPECIES_FIDOUGH] =
    {
        ...
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_NONE, ABILITY_CRAFTY },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_TADBULB] =
    {
        ...
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_STATIC, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_BELLIBOLT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_ELECTROMORPHOSIS, ABILITY_STATIC, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_BRAMBLIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_KUSANAGI, ABILITY_NONE, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CAPSAKID] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_INSOMNIA, ABILITY_CRAFTY },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_GREAVARD] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_NIGHT, 39, SPECIES_HOUNDSTONE}),
    },
    ...
    [SPECIES_FLAMIGO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_GUTS, ABILITY_TANGLED_FEET, ABILITY_COSTAR },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_POLTCHAGEIST_COUNTERFEIT] =
    {
        ...
        .abilities = { ABILITY_HOSPITALITY, ABILITY_NONE, ABILITY_HEAT_TREATMENT },
        .bodyColor = BODY_COLOR_GREEN,
...
#define OGERPON_SPECIES_INFO(Form1, Form2, type, ability, color, iconpalette, isTeraform)   \
    ...
    [SPECIES_OGERPON_TEAL]             = OGERPON_SPECIES_INFO(Teal,        Teal,            TYPE_DARK, ABILITY_PRANKSTER,                        BODY_COLOR_GREEN, 1, FALSE),
    [SPECIES_OGERPON_WELLSPRING]       = OGERPON_SPECIES_INFO(Wellspring,  Wellspring,      TYPE_WATER, ABILITY_SERENE_GRACE,                   BODY_COLOR_BLUE,  0, FALSE),
    [SPECIES_OGERPON_HEARTHFLAME]      = OGERPON_SPECIES_INFO(Hearthflame, Hearthflame,     TYPE_FLAME,  ABILITY_RECKLESS,                   BODY_COLOR_RED,   0, FALSE),
