...
const u8 gText_VanilliteAndPrice[] = _("VANILLITE{CLEAR_TO 0x48}500 COINS");
const u8 gText_VaroomAndPrice[] = _("VAROOM{CLEAR_TO 0x48}1,500 COINS");
const u8 gText_DittoAndPrice[] = _("DITTO{CLEAR_TO 0x48}2,500 COINS");
const u8 gText_PorygonAndPrice[] = _("PORYGON{CLEAR_TO 0x48}5,000 COINS");
const u8 gText_RotomAndPrice[] = _("ROTOM{CLEAR_TO 0x48}5,000 COINS");
